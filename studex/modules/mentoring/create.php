...
//  modules/mentoring/create.php — Tambah Sesi Mentoring
// ============================================================
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $db->prepare("
            INSERT INTO mentoring_sesi
                (angkatan_id, judul, tanggal, waktu_mulai, waktu_selesai,
                 lokasi, mentor, deskripsi, status, created_by)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
        $stmt->execute([
            $input['angkatan_id'],
        ...
        setFlash('success', 'Sesi mentoring "' . $input['judul'] . '" berhasil ditambahkan.');
        redirect(url('modules/mentoring/detail.php?id=' . $newId));
    }
}
...
// LAYOUT
// ============================================================
$pageTitle   = 'Tambah Sesi Mentoring';
...
<div class="card" style="max-width:760px;">
    <div class="card-header">
        <div class="card-title">Form Tambah Sesi Mentoring</div>
    </div>
    ...
    <form method="POST" action="" novalidate>
        ...
        <div class="form-group mb-5">
            ...
            <input type="text" name="judul"
                   ...
                   value="<?= e($input['judul'] ?? '') ?>"
                   placeholder="Contoh: Mentoring Pekan 2 — Kepemimpinan">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="<?= url('modules/mentoring/index.php') ?>" class="btn btn-secondary">Batal</a>
        </div>
