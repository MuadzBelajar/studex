...
//  modules/rabuan/edit.php — Edit Rapat Rabuan
// ============================================================
...
// Ambil data
$stmt = $db->prepare("SELECT * FROM rabuan WHERE id = ?");
$stmt->execute([$id]);
$rabuan = $stmt->fetch();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        setFlash('success', 'Rapat berhasil diperbarui.');
...
<div class="card" style="max-width:760px;">
    <div class="card-header">
        <div class="card-title">Edit Rapat Rabuan</div>
        <div class="card-subtitle">ID #<?= $id ?> &mdash; Dibuat <?= timeAgo($rabuan['created_at']) ?></div>
    </div>
    ...
    <form method="POST" action="" novalidate>
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="<?= url('modules/rabuan/detail.php?id=' . $id) ?>" class="btn btn-secondary">Batal</a>
        </div>
